            ...
            <div class="col-md-10">
                <div class="card border-0 shadow-lg my-4">
                    <div class="card-header bg-dark">
                        <h3 class="text-white">Edit Employee</h3>
                    </div>
                        ...
                        <div class="card-body">
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control @error('name') is-invalid @enderror"
                                    name="name" placeholder="Enter Employe Name" value="{{ $employee->name }}">
                                @error('name')
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control @error('role') is-invalid @enderror"
                                    name="role" placeholder="Job Position" value="{{ $employee->role }}">
                                @error('role')
                                    <p class="invalid-feedback">{{ $message }}</p>
                                @enderror
                            </div>
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control @error('salary') is-invalid @enderror"
                                    name="salary" placeholder="Enter Employe Salary" value="{{ $employee->salary }}">
                                @error('salary')
                                    <p class="invalid-feedback">{{ $message }}</p>
                                @enderror
                            </div>
